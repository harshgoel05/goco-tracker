...
export class CountriesComponent implements OnInit {
  ...
  private PieChartLabels = new Array
  ...
  public pieChartColors = [
    {
      backgroundColor: ['rgba(255,0,0,0.5)', 'rgb(169,169,169,0.6)', 'rgb(0,255,0,0.3)'],
    },
  ];
  ...
  getStateData(){
    this.dataService.getIndiaStateData()
    .subscribe(res => {
      console.log(res)
      let i=0;
  ...
  getDailyData(){
    ...
    .subscribe( res => {
      ...
      this.PieData[0].data=[this.active[i-1],res[i-1].totaldeceased,res[i-1].totalrecovered]
      this.PieChartLabels=["Total confirmed","Total deceased","Total Recovered"]
